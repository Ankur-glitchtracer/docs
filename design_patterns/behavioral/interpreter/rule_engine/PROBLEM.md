...
!!! info "Why Use This Pattern?"
    ...
    - **Separates expression logic from interpretation**
...
- [Composite](../../../structural/composite/organisation_chart/PROBLEM.md) — An Interpreter is often a Composite tree.
- [Flyweight](../../../structural/flyweight/forest_simulator/PROBLEM.md) — Flyweight can be used to share terminal symbols in the grammar.
- [Visitor](../../visitor/PROBLEM.md) — Visitor can be used to maintain state while traversing the syntax tree.
