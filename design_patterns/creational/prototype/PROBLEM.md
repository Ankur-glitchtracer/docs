...
!!! info "Why Use This Pattern?"
    ...
    - **Avoids reliance on subclasses for object creation**
    - **Allows dynamic configuration of objects**
...
- [Factory Method](../factory/document_factory/PROBLEM.md) — Factory Method often uses Prototype to clone objects instead of instantiating them.
- [Command](../../behavioral/command/smart_home_hub/PROBLEM.md) — Prototype can be used to clone Commands.
